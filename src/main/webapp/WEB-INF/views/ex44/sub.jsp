...
document.querySelector("#btn13").addEventListener("click", function() {
	...
	const hasCar = hasCarCheckbox != null; //true나 false 하나만
	const foodCheckBoxs = document.querySelectorAll(".foodCheckbox3:checked");
	const food = []; //여러개가 담길 수 있음
	...
	*/
	// for of
	for (const foodCheckBox of foodCheckBoxs) { //js의 향상된 for문
