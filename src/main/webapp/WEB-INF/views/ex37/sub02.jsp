...
<body>
	...
	<br>
	<input type="text" placeholder="우편주소" value="${supplier.postalCode }" name="postalCode">
	<br>
	<input type="text" placeholder="도시" value="${supplier.city }" name="city">
	<br>
	<input type="text" placeholder="국가" value="${supplier.country }" name="country">
	<br>
	<input type="text" placeholder="연락처" value="${supplier.phone }" name="phone">
	<br>
