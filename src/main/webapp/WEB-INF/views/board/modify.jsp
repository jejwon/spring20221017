...
<body>
	...
	<div class="container-md">
		<div class="row">
			...
			<form id="modifyForm" action="" method="post"> <!-- modifyButton을 누르면 form이 전송되어야함->form에 id 설정 -->
				...
				<!-- .mb-3*4>label.form-label+input.form-control -->
				 ...
				 <div class="mb-3">
				 	...
				 	<textarea type="text" name="content" class="form-control" >${board.content }</textarea>
				 </div>
				 <div class="mb-3">
